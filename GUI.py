...
v["values"] = 'Model-Harmonic Oscillator', 'Model-Morse Oscillator', 'Read Structures and Energies from File', 'Compute on The Fly'
...
calculate = tk.Button(window, text ='Calculate', bd ='20', bg='green', fg='white',
                command = window.destroy).place(x=450, y= 170)

clear = tk.Button(window, text ='Clear', bd ='10', bg='blue', fg='white',
                command = window.destroy).place(x=565, y= 180)

# Adding combobox drop down list
# monthchoosen['values'] = (multiprocessing.cpu_count())
cpu_count()
