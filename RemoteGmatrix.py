...
def calcGMatrix(N, pes, equil):
    dx1dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy1dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx2dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy2dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx3dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy3dq1 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx1dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy1dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx2dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy2dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx3dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy3dq2 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx1dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy1dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx2dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy2dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dx3dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    dy3dq3 = np.zeros([int(N[0]), int(N[1]), int(N[2])])
    ...
    Gmatrix = np.zeros([int(N[0]), int(N[1]), int(N[2]), 3, 3], float)
