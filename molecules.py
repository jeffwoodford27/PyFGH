...
#holder1.setequilibrium_file(x)
holder1.setpotential_energy(y)

file = DataObject.test.equilibrium_file
potential_file = y
def molecule_testing(N1, L1, N2, L2, N3, L3):
    holder_file = holder1.equilibrium_file
    print(file)
    N1_1 = N1
    N2_1 = N2
    N3_1 = N3
    ...
    print("This is from the molecule gui: ",  test.Z)
    getNs()
    ...
    with open(y, encoding="utf-8") as a:
        for x in a:
